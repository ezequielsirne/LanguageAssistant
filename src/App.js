          ...
          <Row className="justify-content-center align-items-center vh-100">
            <div className="card" style={{width: "18rem"}}>
              <div className="card-body">
                ...
                <p className="card-text">This language assistant will help you practice your English daily by correcting any mistakes you may have.
                                               You just have to give it your name and it will start a casual conversation with you about any random topic.</p>
